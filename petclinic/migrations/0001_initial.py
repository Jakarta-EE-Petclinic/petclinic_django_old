# Generated by Django 2.2.6 on 2019-10-29 19:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pet_owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='owner_pets', to='petclinic.Owner')),
            ],
        ),
        migrations.CreateModel(
            name='PetType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visit_pet', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pet_visits', to='petclinic.Pet')),
            ],
        ),
        migrations.CreateModel(
            name='Veterinarian',
        ...
        migrations.AddField(
            model_name='pet',
            name='pet_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pet_type_pets', to='petclinic.PetType'),
        ),
    ]
